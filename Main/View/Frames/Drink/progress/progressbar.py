...
class ProgressBar(ttk.Frame):
    ...
    def init_content(self, beverage):
        ...
        ttk.Style().configure('progressbar.TLabel', background="#201F1E", font="Helvetica 20",
                              foreground="white", justify="center", anchor="center")
        ttk.Label(self, text="Dein Getränk wird gerade gemixt", style="progressbar.big.TLabel").place(x=400, y=70,
                                                                                                      anchor="center")
        ttk.Label(self, text="gleich ist es soweit :)", style="progressbar.small.TLabel").place(x=400, y=150,
                                                                                                anchor="center")
        ttk.Label(self, text="Dein Getränk: " + beverage.name, style="progressbar.small.TLabel").place(x=400, y=350,
                                                                                                       anchor="center")
        TROUGH_COLOR = '#201F1E'
        BAR_COLOR = '#871352'
